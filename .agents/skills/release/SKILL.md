...
4. Validate before committing:
   ...
   ```sh
   jq . .codex-plugin/plugin.json plugins/hhk7734/.codex-plugin/plugin.json .claude-plugin/plugin.json .claude-plugin/marketplace.json gemini-extension.json >/dev/null
